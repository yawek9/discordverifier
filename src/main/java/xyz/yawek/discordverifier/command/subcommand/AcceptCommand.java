...
public class AcceptCommand extends PermissibleCommand {

    public AcceptCommand(DiscordVerifier verifier) {
        super(verifier, "discordverifier.accept");
    }
    ...
    protected void handle(CommandSource source, String[] args) {
        ...
        verifier.getVerificationManager()
                .completeVerification((Player) source, true);
    }
